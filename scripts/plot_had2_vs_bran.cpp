...
inline void plot_had2_vs_bran() {
  ...
  for (auto const& side : SIDES) {
    hHAD1VsBRAN.at(side) = new TH2D(Form("side%c_HAD2VsBRAN", getSideLabel(side)), ";HAD2 Truth Energy [MeV];BRAN Truth Energy [MeV];Count", BINS(axis::EMTruth.withBins(32)), BINS(axis::BRANTruth.withBins(32)));
  }

...
inline void plot_rpd_vs_bran() {
  ...
  for (auto const& side : SIDES) {
    hHAD1VsBRAN.at(side) = new TH2D(Form("side%c_RPDVsBRAN", getSideLabel(side)), ";RPD Truth Energy [MeV];BRAN Truth Energy [MeV];Count", BINS(axis::EMTruth.withBins(32)), BINS(axis::BRANTruth.withBins(32)));
  }
